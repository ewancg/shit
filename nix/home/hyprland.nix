...
in
{
  ...
  settings = {
    ...
    windowrulev2 = [
      ...
      "bordercolor rgba(89b4fabb), floating:1" # Blue
      "bordercolor rgba(a6e3a1ff), initialtitle:^(Spotify Premium)" # Green
      "bordercolor rgba(a6e3a1bb), initialtitle:^(Spotify Premium),floating:1" # Green
      "bordercolor rgba(a6e3a1ff), initialclass:^(dev.alextren.Spot)" # Green
      "bordercolor rgba(a6e3a1bb), initialclass:^(dev.alextren.Spot),floating:1" # Green
      "bordercolor rgba(cba6f7ff), initialclass:^(obsidian|Alacritty)" # Purple
      "bordercolor rgba(cba6f7bb), initialclass:^(obsidian|Alacritty),floating:1" # Purple
      "bordercolor rgba(a6e3a1ff), xwayland:1" # Yellow f9e2afff
      "bordercolor rgba(a6e3a1bb), xwayland:1,floating:1" # Yellow f9e2afbb
      "bordercolor rgba(f38ba8ff), fullscreen:1" # Red
    ];
    ...
    bind = [
      ...
      ",XF86AudioMute, exec, $HOME/.local/bin/dunst-status-change volume mute"
    ...
    monitor = [
      "desc:${m1.desc}, modeline ${m1.mode}, ${m1.pos}, ${m1.scale}, bitdepth,10"
      "desc:${m2.desc}, modeline ${m2.mode}, ${m2.pos}, ${m2.scale}, bitdepth,10"
